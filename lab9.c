...
int main(void)
{
	...
	// Choose an appropriate hash table size, e.g., double the number of records for simplicity
	int hashSz = recordSz;
	...
	for (int i = 0; i < recordSz; ++i)
	{
		...
		pHashArray[index].record = pRecords[i];
		pHashArray[index].occupied = 1;
	}
